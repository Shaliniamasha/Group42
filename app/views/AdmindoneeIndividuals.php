  ...
  <div class="main--content">
    <div class="header--wrapper">
      ...
      <div class="header--buttons">
        <a href="admindoneeindv_deact"><button class="deactivated-button">Deactivated</button></a>
        <a href="admindoneeindv_pend"></a><button class="pending-button">Pending</button></a>
      </div>
      <div class="user--info">
