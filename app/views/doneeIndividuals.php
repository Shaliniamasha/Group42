...
<head>
  ...
  <!--link rel="stylesheet" href="give4good/app/views/h_style7.css"-->
  ...
  <div class="main--content">
    <div class="header--wrapper">
      ...
      <div class="header--buttons">
        <a href="<?php echo URLROOT ?>/admin/admindonee_deact"><button class="deactivated-button">Deactivated</button></a>
        <a href="<?php echo URLROOT ?>/admin/admindonee_pend"></a><button class="pending-button">Pending</button></a>
      </div>
      <div class="user--info">
