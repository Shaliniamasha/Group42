...
<body>
    ...
    <h2>
        ...
        <div class="profile">
        <h2>
        <a href="<?php echo URLROOT ?>/stories/create"><i class="fas fa-plus-circle"></i></a> Uploaded Stories
    </h2>
            <ul>
            <li>
    ...
    <h2>
        ...
        <div class="profile">
        <h2>
        <i class="fas fa-plus-circle"></i> Merchandise Sold
    </h2>

            <ul>
        <li>
            T-shirts - Available: 50
            <button class="delete-button">
                <i class="fas fa-trash-alt"></i>
            </button>
        </li>
        <li>
            ...
            <form action="/edit-merchandise" method="post">
                <label for="tshirts">Edit T-shirts Stock:</label>
                <input type="number" id="tshirts" name="tshirts" value="50">
                <label for="mugs">Edit Mugs Stock:</label>
                <input type="number" id="mugs" name="mugs" value="20">
                <button type="submit">Save</button>
            </form>
        </div>
    </div>
