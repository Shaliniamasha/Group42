            ...
            <div class="row no-gutters row-bordered row-border-light">
                <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                        ...
                        <a class="list-group-item list-group-item-action"
                            onclick="showTab('stories-of-others')">Stories</a>
                    </div>
                </div>
                <div class="col-md-9">
...
                      <div class="tab-pane fade" id="stories-of-others">
    <div class="card-body pb-2">
        <button type="button" class="btn btn-primary mb-2" onclick="addStory()">Add Story</button>
        <div id="stories-list">
            <!-- This will be populated dynamically with JavaScript -->
        </div>
    </div>
...
    <script type="text/javascript">
    ...
    function addStory() {
            ...
            story.className = "card mb-3";
            story.innerHTML = `
                <div class="card-body">
                    <h5 class="card-title">Heading: <input type="text" class="form-control d-inline" style="width: 60%;" value=""></h5>
                    <p class="card-text">Story: <textarea class="form-control mb-1" rows="5"></textarea></p>
                    <label class="form-label">Photo (optional)</label>
                    <input type="file" class="form-control mb-1">
                    <button type="button" class="btn btn-success btn-show-story">Show Story</button>
                    <button type="button" class="btn btn-danger btn-remove-story">Remove Story</button>
                </div>
            `;

            var showButton = story.querySelector(".btn-show-story");
            var removeButton = story.querySelector(".btn-remove-story");

            showButton.addEventListener("click", function () {
                // Show the story logic here
            });
